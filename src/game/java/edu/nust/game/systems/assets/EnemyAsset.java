...
/**
 * Enumeration of available enemy sprites in the PostApocalypse asset pack. Different zombie variants with unique
 * appearances and sizes. Implements {@link AssetEnum} to follow the standard asset management pattern.
 */
