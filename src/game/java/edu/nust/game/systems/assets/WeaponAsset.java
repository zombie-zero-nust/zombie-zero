...
/**
 * Enumeration of available weapon sprites in the PostApocalypse asset pack. Includes pickable weapon items and
 * character-held weapon variants. Implements {@link AssetEnum} to follow the standard asset management pattern.
 */
