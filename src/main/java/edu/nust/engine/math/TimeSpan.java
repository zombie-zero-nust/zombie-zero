...
public class TimeSpan
{
    ...
    {
        return new TimeSpan((long) (s * 1_000_000_000));
    }

    public static TimeSpan fromMilliseconds(double ms)
    {
        return new TimeSpan((long) (ms * 1_000_000));
    }

    public static TimeSpan fromMicroseconds(double us)
    {
        return new TimeSpan((long) (us * 1_000));
    }
